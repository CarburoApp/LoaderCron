package app.carburo.loader.application.persistance.combustibledisponible.impl;


import app.carburo.loader.application.persistance.combustibledisponible.CombustibleDisponibleGateway.CombustibleDisponibleRecord;
...
import static app.carburo.loader.config.persistencia.DBColumns.COMBUSTIBLE_DISPONIBLE_ID_COMBUSTIBLE;
import static app.carburo.loader.config.persistencia.DBColumns.COMBUSTIBLE_DISPONIBLE_ID_EESS;
