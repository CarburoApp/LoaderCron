package app.carburo.loader.application.model;
...
public class ComunidadAutonoma implements Serializable {
	...
	public boolean equals(Object o) {
		...
		ComunidadAutonoma comunidadAutonoma = (ComunidadAutonoma) o;
		return id == comunidadAutonoma.id;
	}
	...
	public String toString() {
		return "CA{" + "id=" + id + ", denominacion='" + denominacion + '\'' +
				", extCode=" + extCode + '}';
	}
}
