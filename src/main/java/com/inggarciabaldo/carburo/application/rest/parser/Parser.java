...
//		List<Provincia> todasProvincias = RepositoryFactory.getProvinciaRepository()
//				.findAll();
//		List<Municipio> todosMunicipios = RepositoryFactory.getMunicipioRepository()
//				.findAll();
//		List<Combustible> todosCombustibles = RepositoryFactory.getCombustibleRepository()
//				.findAll();
//
...
//		Set<BigDecimal> eessExistentes = RepositoryFactory.getEESSRepository()
//				.findAllExtCodes();
//
//
//		this.eessParser = new EESSParser(provinciasMap, municipiosMap, combustiblesMap,
//										 eessExistentes);
//	}
