package com.inggarciabaldo.carburo.parser.customJsonDeserializer;
...
public abstract class BasePropertyDeserializer<T> implements JsonDeserializer<T> {
    ...
    protected static final Properties keys = PropertyLoader.getInstance().getJsonKeysProperties();

    protected static final Type LIST_ES_PARSER_TYPE = new TypeToken<List<com.inggarciabaldo.carburo.parser.dto.EETT.ESParserDTO>>() {}.getType();
     ...
     */
    @Override
    public abstract T deserialize(JsonElement json, Type typeOfT, JsonDeserializationContext context)
